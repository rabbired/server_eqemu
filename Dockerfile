...
RUN wget http://ftp.us.debian.org/debian/pool/main/libs/libsodium/libsodium-dev_1.0.11-1~bpo8+1_amd64.deb -O ./libsodium-dev.deb && \
	...
	wget -N --cache=no --no-check-certificate -O /home/eqemu/server/sql/peq_beta.zip \
        https://raw.githubusercontent.com/rabbired/EQEmuFullDB/master/peq_beta.zip && \
	wget -N --cache=no --no-check-certificate -O /home/eqemu/map.zip \
	http://github.com/Akkadius/EQEmuMaps/archive/master.zip && \
	wget -N --cache=no --no-check-certificate -O /home/eqemu/quests.zip \
	https://github.com/ProjectEQ/projecteqquests/archive/master.zip
...
RUN cp -rf /home/eqemu/EQEmuInstall/linux/* /home/eqemu/server && \
	...
	unzip -o /home/eqemu/map.zip -d ./ && unzip -o /home/eqemu/quests.zip -d ./ && \
	rm -rf /home/eqemu/server/Maps /home/eqemu/server/quests /home/eqemu/server/plugins /home/eqemu/server/lua_modules && \
	mv -f ./EQEmuMaps-master /home/eqemu/server/Maps && \
	mv -f ./projecteqquests-master /home/eqemu/server/quests && \
